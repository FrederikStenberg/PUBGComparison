...
function compare() {
    ...
    req2.onreadystatechange = function() {
        if(this.readyState == 4 && this.status == 200) {
            ...
            player1LongestKill = obj2JSON.data.attributes.gameModeStats["duo-fpp"].longestKill;
            ...
            player1WinRatio = (player1Wins / player1Rounds) * 100;
    ...
    req3.onreadystatechange = function() {
        if(this.readyState == 4 && this.status == 200) {
            ...
            var urlForSeasonObject1 = "https://api.playbattlegrounds.com/shards/" + region2 + "/players/" + player2ID + "/seasons/division.bro.official.2018-04";
    ...
    req4.onreadystatechange = function() {
        if(this.readyState == 4 && this.status == 200) {
            ...
            player2LongestKill = obj4JSON.data.attributes.gameModeStats["duo-fpp"].longestKill;
            ...
            player2WinRatio = (player2Wins / player2Rounds) * 100;
            ...
            alert("P1 Winrate: " + player1WinRatio + " P2 Winrate: " + player2WinRatio);
        }
    }
