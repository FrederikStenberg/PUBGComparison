...
//Start compare function, called when "Compare" button is clicked
function compare() {
    ...
    //List of requests that are used to call to the API
    var req = new XMLHttpRequest();
    var req2 = new XMLHttpRequest();
    var req3 = new XMLHttpRequest();
    var req4 = new XMLHttpRequest();
    
    //URLs for getting the two player IDs
    ...
    //Session storage is used to store information across HTML files
    sessionStorage.setItem("playerName1", player1);
    sessionStorage.setItem("playerName2", player2);

    //Change season to be proper string depending on month input value
